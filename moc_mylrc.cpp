...
**
** Created: Wed May 7 18:34:36 2014
...
static const char qt_meta_stringdata_MyLrc[] = {
    "MyLrc\0\0timeout()\0"
};
...
const QMetaObjectExtraData MyLrc::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MyLrc::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_MyLrc,
      qt_meta_data_MyLrc, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MyLrc::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyLrc))
